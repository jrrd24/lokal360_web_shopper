...
const PromoToggle = ({ name, control, data, value, handlePromoError }) => {
  const labelStyle = {
    display: "flex",
    ...
    <Controller
      ...
      render={({ field, fieldState }) => (
        <>
                    ...
                    <Box>
                      ...
                      >
                        <Box
                          sx={{
                            backgroundColor:
                              promo.promo_type_name === "Peso Discount"
                                ? theme.palette.promo.peso
                                : promo.promo_type_name === "Percent Discount"
          ...
          {fieldState.error &&
            handlePromoError("error", "Please select a promo.")}
        </>
      )}
    />
  );
            ...
            <Box>
              ...
              >
                ...
                <Stack>
                  ...
                  <Typography variant="sectionTitleSmall">
                    <TruncateString
                      str={promo.promo_type || promo.PromoType?.promo_type_name}
                      n={30}
                    />
                  </Typography>
...
const NullImage = () => {
  return (
    <Stack sx={{ display: "flex", justifyContent: "center", p: 5 }}>
      <div>
        <svg
